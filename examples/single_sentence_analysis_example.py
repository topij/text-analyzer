...
async def main():
    ...
    try:
        ...
        # Example 7: Training Services Analysis (Finnish)
        print("\n=== Training Services Analysis (Finnish) ===")
        text_training_fi = "Onko yrityskoulutuspaketteihin saatavilla ryhmäalennuksia? Meillä on 10 hengen kehittäjätiimi."
        await runner.analyze_single_text(
            text=text_training_fi,
            language="fi",
            analysis_types=["keywords", "themes", "categories"],
        ...
        # Example 8: Training Services Analysis (Finnish)
        print("\n=== Training Services Analysis (Finnish) ===")
        text_training_fi = "Minun täytyy siirtää tuleva Python-ohjelmoinnin työpaja. Mikä on prosessi tähän?"
        await runner.analyze_single_text(
            text=text_training_fi,
            language="fi",
            analysis_types=["keywords", "themes", "categories"],
